...
const data: Array<Board> = [
  ...
  new Board({
    ...
    labels: [
      new Label({ text: "fix", color: "#ff0000" }),
      new Label({ text: "feat", color: "#008800" }),
      new Label({ text: "docs", color: "#ffa500" }),
      new Label({ text: "test", color: "#800080" }),
      new Label({ text: "refactor", color: "#0000ff" }),
    ],
    lists: [
      new List({
        id: "to-do",
